...
import { getSubSectionData, changeApiErrorSection } from '../../../../actions/stat';
import ApiErrorTable from '../../../blocks/ApiErrorTable';
...
class ApiErrorSection extends Component {
    ...
    onFactorChange(val) {
        this.props.dispatch(changeApiErrorSection({factorKey: val}));
    }
